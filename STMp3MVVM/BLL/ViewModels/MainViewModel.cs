...
namespace BLL.ViewModels
{
    public class MainViewModel : ViewModelBase
    {
        ...
        public string SavePath
        {
            get
            {
                return string.IsNullOrEmpty(Properties.Settings.Default.SavePath) ? Environment.GetFolderPath(Environment.SpecialFolder.MyMusic) : Properties.Settings.Default.SavePath;
            }
            set
            {
